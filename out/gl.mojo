...
struct ErrorCode:
    ...
    alias GL_NO_ERROR = ErrorCode(0)
    alias GL_INVALID_ENUM = ErrorCode(0x0500)
    alias GL_INVALID_VALUE = ErrorCode(0x0501)
    alias GL_INVALID_OPERATION = ErrorCode(0x0502)
    alias GL_STACK_OVERFLOW = ErrorCode(0x0503)
    alias GL_STACK_UNDERFLOW = ErrorCode(0x0504)
    alias GL_OUT_OF_MEMORY = ErrorCode(0x0505)
    alias GL_INVALID_FRAMEBUFFER_OPERATION = ErrorCode(0x0506)
    alias GL_INVALID_FRAMEBUFFER_OPERATION_EXT = ErrorCode(0x0506)
    alias GL_INVALID_FRAMEBUFFER_OPERATION_OES = ErrorCode(0x0506)
    alias GL_TABLE_TOO_LARGE_EXT = ErrorCode(0x8031)
    alias GL_TABLE_TOO_LARGE = ErrorCode(0x8031)
    alias GL_TEXTURE_TOO_LARGE_EXT = ErrorCode(0x8065)
...
struct FramebufferStatus:
    ...
    alias GL_FRAMEBUFFER_UNDEFINED = FramebufferStatus(0x8219)
    alias GL_FRAMEBUFFER_COMPLETE = FramebufferStatus(0x8CD5)
    alias GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT = FramebufferStatus(0x8CD6)
    alias GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT = FramebufferStatus(0x8CD7)
    alias GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER = FramebufferStatus(0x8CDB)
    alias GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER = FramebufferStatus(0x8CDC)
    alias GL_FRAMEBUFFER_UNSUPPORTED = FramebufferStatus(0x8CDD)
    alias GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE = FramebufferStatus(0x8D56)
    alias GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS = FramebufferStatus(0x8DA8)
...
struct GraphicsResetStatus:
    ...
    alias GL_NO_ERROR = GraphicsResetStatus(0)
    alias GL_GUILTY_CONTEXT_RESET = GraphicsResetStatus(0x8253)
    alias GL_INNOCENT_CONTEXT_RESET = GraphicsResetStatus(0x8254)
    alias GL_UNKNOWN_CONTEXT_RESET = GraphicsResetStatus(0x8255)
...
struct SyncStatus:
    ...
    alias GL_ALREADY_SIGNALED = SyncStatus(0x911A)
    alias GL_TIMEOUT_EXPIRED = SyncStatus(0x911B)
    alias GL_CONDITION_SATISFIED = SyncStatus(0x911C)
    alias GL_WAIT_FAILED = SyncStatus(0x911D)
